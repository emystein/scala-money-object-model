...
class MoneyTest extends AnyFunSuite with Matchers {
  test("givenTwoAmountsWhenSumThemThenItShouldReturnANewAmountWithTheSum") {
  ...
  test("givenAnAmountWhenMultiplyTheAmountByAFactorThemThenItShouldReturnANewAmountWithTheProduct")  {
